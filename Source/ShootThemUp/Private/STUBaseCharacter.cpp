...
DEFINE_LOG_CATEGORY_STATIC(BassCharacterLog, All, All);
...
{
	//UE_LOG(BassCharacterLog, Display, TEXT("Player is dead"), *GetName());
...
void ASTUBaseCharacter::OnGroundLanded(const FHitResult& Hit)
{
	...
	//UE_LOG(BassCharacterLog, Display, TEXT("On landed: %f"), FallVelocityZ);

	if (FallVelocityZ < LandedDamageVelocity.X) return;

	const auto FinalDamage = FMath::GetMappedRangeValueClamped(LandedDamageVelocity, LandedDamage, FallVelocityZ);
	//UE_LOG(BassCharacterLog, Display, TEXT("FinalDamage: %f"), FinalDamage);
